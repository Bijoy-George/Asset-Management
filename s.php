...
$select = "SELECT  p.*, c.cat_name FROM am_products as p LEFT JOIN am_categories as c ON p.categories=c.id";
...
<div id="nav_bar">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <div class="col-md-3">
                <div class="logo">
                    <a href="employee.php"> <img src="download.jpg" style="width:60px; height:60px" class="img-fluid"></a>
...
<div class="container-fluid">
    ...
    <div class="col-10">
        ...
        <table border="1">
          ...
          elseif ($res['user_name'] == $userid) {
              
              echo "YOU ARE USING IT";
          }
                                                           
            elseif ($res['user_name'] != $userid && $res['status'] !='AVAILABLE') {
